...
import { Tooltip, Button, Typography, ScreenshotCarousel } from "@/components";
import Head from "next/head";
import Image from "next/image";
import { useDate, useFormat, useGamePage } from "@/hooks";
...
export default function GamePage({
  ...
  const { howLongToBeat, achievements, profileGame } = useGamePage(
    id as string,
    "steam"
  );
          ...
          >
            ...
            <div className="game-page__hero-overlay">
              ...
              <div style={{ display: "flex", gap: 16 }}>
                ...
                <Button variant="primary">Open Download Options</Button>
            ...
            {profileGame && (
              <div className="game-page__playtime-bar">
                ...
                <Typography style={{ color: "rgba(255, 255, 255, 0.5)" }}>
                  Last played{" "}
                  {formatDistance(
                    profileGame?.lastTimePlayed as number,
                    new Date(),
                    { addSuffix: true }
                  )}
                </Typography>
